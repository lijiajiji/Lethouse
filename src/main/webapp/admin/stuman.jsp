...
<body>
	<table id="data" title="信息" class="easyui-datagrid"
		...
		<thead>
			<tr>
				<th field="id" checkbox="true">用户编号</th>
				<th field="name" width="100px">用户名称</th>
				<th field="password" width="100px">用户密码</th>
				<th field="telephone" width="100px">电话</th>
				<th field="isadmin" width="100px">是否管理员</th>
